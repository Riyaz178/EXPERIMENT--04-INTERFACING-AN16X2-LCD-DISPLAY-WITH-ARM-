...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd,0,1);
    Lcd_string(&lcd," YOKESH.H	");
    Lcd_cursor(&lcd,1,1);
    Lcd_string(&lcd,"24005930");
  /* USER CODE END 2 */
...
## Output screen shots of proteus  :
 ...
 <img width="1920" height="1200" alt="Screenshot (24)" src="https://github.com/user-attachments/assets/6555e6a7-a3bc-4739-8ea6-24b049968005" />

 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 <img width="934" height="747" alt="image" src="https://github.com/user-attachments/assets/ff79eab0-14c0-4c14-a07b-c15fbcc9d172" />
